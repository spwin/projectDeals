...
(function ($) {
    ...
    $.fn.hasAttr = function (attr) {
        if ((typeof attr === "undefined" ? "undefined" : _typeof(attr)) !== ( true ? "undefined" : _typeof(undefined)) && attr !== false && attr !== undefined) {
            return true;
        }
        return false;
    };
    ...
    var background_image = function background_image() {
        $("[data-bg-img]").each(function () {
            ...
            if ((typeof attr === "undefined" ? "undefined" : _typeof(attr)) !== ( true ? "undefined" : _typeof(undefined)) && attr !== false && attr !== "") {
    ...
    -------------------------------------*/
    var background_color = function background_color() {
    ...
    var link_void = function link_void() {
    ...
    /*-------------------------------------
     HTML attr direction
    -------------------------------------*/
    var html_direction = function html_direction() {
        var html_tag = $("html"),
    ...
    -------------------------------------*/
    var toogle_class = function toogle_class() {
    ...
    /*-------------------------------------
     Back Top functions
    -------------------------------------*/
    var back_to_top = function back_to_top() {
        var backTop = $('#backTop');
        if (backTop.length) {
    ...
    var click_back = function click_back() {
        var backTop = $('#backTop');
    ...
    /*-------------------------------------
     Navbar Functions
    -------------------------------------*/
    var navbar_js = function navbar_js() {
    ...
    var navbar_resize_load = function navbar_resize_load() {
    ...
    /*-------------------------------------
     Social Icons Share
    -------------------------------------*/
    var share_social = function share_social() {
    ...
    -------------------------------------*/
    var add_favorite = function add_favorite() {
    ...
    -------------------------------------*/
    var owl_carousel = function owl_carousel() {
    ...
    -------------------------------------*/
    var data_rating = function data_rating() {
    ...
    var do_rating = function do_rating() {
    ...
    var countdown = function countdown() {
        ...
        countdown_select.each(function () {
            $(this).countdown($(this).data('countdown')).on('update.countdown', function (e) {
                var format = '%H : %M : %S';
    ...
    -------------------------------------*/
    var cart_delete_item = function cart_delete_item() {
