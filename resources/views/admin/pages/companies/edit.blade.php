                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('name')) has-danger @endif">
                                ...
                                <input type="text" id="name" class="slug-source form-control @if($errors->has('name')) is-invalid @endif" name="name" value="{{ old('name', $company->getAttribute('name')) }}"/>
                                @if($errors->has('name'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('slug')) has-danger @endif">
                                ...
                                <input type="text" id="slug" class="slug form-control @if($errors->has('slug')) is-invalid @endif" name="slug" value="{{ old('slug', $company->getAttribute('slug')) }}"/>
                                @if($errors->has('slug'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('email')) has-danger @endif">
                                ...
                                <input type="email" id="email" class="form-control @if($errors->has('email')) is-invalid @endif" name="email" value="{{ old('email', $company->getAttribute('email')) }}"/>
                                @if($errors->has('email'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('website')) has-danger @endif">
                                ...
                                <input type="text" id="website" class="form-control @if($errors->has('website')) is-invalid @endif" name="website" value="{{ old('website', $company->getAttribute('website')) }}"/>
                    ...
                    <div class="card summer_note_display summer_note_btn">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('description')) has-danger @endif">
                                <textarea id="description" class="textarea form_editors_textarea_wysihtml form-control @if($errors->has('description')) is-invalid @endif" name="description">{{ old('description', $company->getAttribute('description')) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body row">
                            @php $social = $company->getAttribute('social') ?: collect([]) @endphp
                            <div class="col-lg-12 input_field_sections @if($errors->has('social.facebook')) has-danger @endif">
                                ...
                                <input type="text" id="social-facebook" name="social[facebook]" class="form-control @if($errors->has('social.facebook')) is-invalid @endif" value="{{ old('social.facebook', $social->get('facebook')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('social.twitter')) has-danger @endif">
                                ...
                                <input type="text" id="social-twitter" name="social[twitter]" class="form-control @if($errors->has('social.twitter')) is-invalid @endif" value="{{ old('social.twitter', $social->get('twitter')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('social.instagram')) has-danger @endif">
                                ...
                                <input type="text" id="social-instagram" name="social[instagram]" class="form-control @if($errors->has('social.instagram')) is-invalid @endif" value="{{ old('social.instagram', $social->get('instagram')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('social.pinterest')) has-danger @endif">
                                ...
                                <input type="text" id="social-pinterest" name="social[pinterest]" class="form-control @if($errors->has('social.pinterest')) is-invalid @endif" value="{{ old('social.pinterest', $social->get('pinterest')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('social.google')) has-danger @endif">
                                ...
                                <input type="text" id="social-google" name="social[google]" class="form-control @if($errors->has('social.google')) is-invalid @endif" value="{{ old('social.google', $social->get('google')) }}"/>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body row">
                            @php $seo = $company->getAttribute('seo') ?: collect([]) @endphp
