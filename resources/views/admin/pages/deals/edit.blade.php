...
@section('content')
    ...
    <div class="outer">
        <form action="{{ route('admin.deals.save', ['id' => $deal->getAttribute('id')]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('name')) has-danger @endif">
                                ...
                                <input type="text" id="name" class="slug-source form-control @if($errors->has('name')) is-invalid @endif" name="name" value="{{ old('name', $deal->getAttribute('name')) }}"/>
                                @if($errors->has('name'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('slug')) has-danger @endif">
                                ...
                                <input type="text" id="slug" class="slug form-control @if($errors->has('slug')) is-invalid @endif" name="slug" value="{{ old('slug', $deal->getAttribute('slug')) }}"/>
                                @if($errors->has('slug'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('link')) has-danger @endif">
                                ...
                                <input type="text" id="link" class="form-control @if($errors->has('link')) is-invalid @endif" name="link" value="{{ old('link', $deal->getAttribute('link')) }}"/>
                                @if($errors->has('link'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('price')) has-danger @endif">
                                ...
                                <input type="number" id="price" class="form-control @if($errors->has('price')) is-invalid @endif" name="price" value="{{ old('price', $deal->getAttribute('price')) }}"/>
                                @if($errors->has('price'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('company_id')) has-danger @endif">
                                <select class="form-control chzn-select" id="company_id" name="company_id" tabindex="2">
                                    ...
                                    @foreach($companies as $company)
                                        <option value="{{ $company->getAttribute('id') }}" @if($company->getAttribute('id') == old('company_id', $deal->getAttribute('company_id'))) selected @endif>{{ $company->getAttribute('name') }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('image')) has-danger @endif">
                                <input type="file" name="image" class="dropify" data-max-file-size="3M" @if($image = $deal->getImage()) data-default-file="{{ $image }}" @endif/>
                                @if($errors->has('image'))
                    ...
                    <div class="card summer_note_display summer_note_btn">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('description')) has-danger @endif">
                                <textarea id="description" class="textarea form_editors_textarea_wysihtml form-control @if($errors->has('description')) is-invalid @endif" name="description">{{ old('description', $deal->getAttribute('description')) }}</textarea>
                    ...
                    <div class="card summer_note_display summer_note_btn">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('terms_and_conditions')) has-danger @endif">
                                <textarea id="terms_and_conditions" class="textarea form_editors_textarea_wysihtml form-control @if($errors->has('terms_and_conditions')) is-invalid @endif" name="terms_and_conditions">{{ old('terms_and_conditions', $deal->getAttribute('terms_and_conditions')) }}</textarea>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body row @if($errors->has('gallery')) has-danger @endif">
                            <div id="delete_gallery"></div>
                            @for($i = 0; $i < 4; $i++)
                                @if($image = $deal->getRelation('gallery')->where('pivot.order', $i)->first())
                                    <div class="col-lg-6 input_field_sections">
                                        <input type="file" name="gallery[{{ $i }}]" data-order="{{ $i }}" class="dropify" data-current="{{ $image->getAttribute('id') }}" data-max-file-size="3M" data-default-file="{{ $image->original() }}" />
                                    </div>
                                @else
                                    <div class="col-lg-6 input_field_sections">
                                        <input type="file" name="gallery[{{ $i }}]" data-order="{{ $i }}" class="dropify" data-max-file-size="3M"/>
                                    </div>
                                @endif
                            @endfor
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body row">
                            @php $location = $deal->getAttribute('location') ?: collect([]) @endphp
                            <div class="col-lg-6 input_field_sections @if($errors->has('location.lat')) has-danger @endif">
                                <label for="location-lat">Latitude</label>
                                <input type="text" id="location-lat" class="form-control @if($errors->has('location.lat')) is-invalid @endif" name="location[lat]" value="{{ old('location.lat', $location->get('lat')) }}"/>
                            ...
                            <div class="col-lg-6 input_field_sections @if($errors->has('location.lon')) has-danger @endif">
                                ...
                                <input type="text" id="location-lon" class="form-control @if($errors->has('location.lon')) is-invalid @endif" name="location[lon]" value="{{ old('location.lon', $location->get('lon')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('maps_link')) has-danger @endif">
                                ...
                                <input type="text" id="maps-link" class="form-control @if($errors->has('maps_link')) is-invalid @endif" name="maps_link" value="{{ old('maps_link', $deal->getAttribute('maps_link')) }}"/>
                    ...
                    @if($map = $deal->getRelation('map'))
                        <div class="card">
                            <div class="card-header">
                                Map
                            </div>
                            <div class="card-body row">
                                <img class="mt-3 map-preview" src="{{ $map->original() }}" />
                            </div>
                        </div>
                    @endif
                </div>
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body row">
                            @php $seo = $deal->getAttribute('seo') ?: collect([]) @endphp
                            <div class="col-lg-12 input_field_sections @if($errors->has('seo.title')) has-danger @endif">
                                <label for="seo-title">Title</label>
                                <input type="text" id="seo-title" class="form-control @if($errors->has('seo.title')) is-invalid @endif" name="seo[title]" value="{{ old('seo.title', $seo->get('title')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('seo.description')) has-danger @endif">
                                ...
                                <textarea id="seo-description" class="form-control @if($errors->has('seo.description')) is-invalid @endif" name="seo[description]">{{ old('seo.description', $seo->get('description')) }}</textarea>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('seo.keywords')) has-danger @endif">
                                ...
                                <textarea id="seo-keywords" class="form-control @if($errors->has('seo.keywords')) is-invalid @endif" name="seo[keywords]">{{ old('seo.keywords', $seo->get('keywords')) }}</textarea>
    ...
    <script>
        ...
        $(function(){
            ...
            dropify.on('dropify.afterClear', function(event, element){
                var current = $(element.element).attr('data-current');
                var order = $(element.element).attr('data-order');
                if(current){
                    var delete_container = $('div#delete_gallery');
                    var delete_gallery = delete_container.find('input');
                    var exists = false;
                    $.each(delete_gallery, function(i, e){
                        if($(e).val() === current){
                            exists = true;
                        }
                    });
                    if(!exists){
                        delete_container.append('<input type="hidden" name="delete_gallery[' + order + ']" value="' + current + '"/>')
                    }
                }
            });
