                        ...
                        <div class="card-body row">
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('reward')) has-danger @endif">
                                ...
                                <select class="form-control" id="reward" name="reward">
                                    ...
                                    <option value="any" @if(old('reward', $deal->getAttribute('name')) == 'any') selected @endif>Any</option>
                                    @foreach(rewards() as $slug => $title)
                                        <option value="{{ $slug }}" @if(old('reward', $deal->getAttribute('reward')) == $slug) selected @endif>{{ $title }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('description')) has-danger @endif">
                                ...
                                <textarea id="description" class="form-control @if($errors->has('description')) is-invalid @endif" name="description">{{ old('description', $deal->getAttribute('description')) }}</textarea>
