...
@section('content')
    ...
    <div class="outer">
        <form action="{{ route('admin.listings.add') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('deal_id')) has-danger @endif">
                                <select class="form-control chzn-select" id="deal_id" name="deal_id" tabindex="2">
                                    ...
                                    @foreach($deals as $deal)
                                        <option value="{{ $deal->getAttribute('id') }}" @if($deal->getAttribute('id') == old('deal_id')) selected @endif>{{ $deal->getAttribute('name') }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('weeks')) has-danger @endif">
                                ...
                                <input type="number" id="weeks" class="form-control @if($errors->has('weeks')) is-invalid @endif" name="weeks" value="{{ old('weeks') }}"/>
                                @if($errors->has('weeks'))
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('coupons_count')) has-danger @endif">
                                ...
                                <input type="number" id="count" class="form-control @if($errors->has('coupons_count')) is-invalid @endif" name="coupons_count" value="{{ old('coupons_count') }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('status')) has-danger @endif">
                                ...
                                <select class="form-control" id="status" name="status">
                                    @foreach(listingStatuses() as $id => $status)
                                        <option value="{{ $id }}" @if(old('status') == $id) selected @endif>{{ $status}}</option>
                                    @endforeach
                                </select>
                            ...
                            <label class="custom-control mt-4">
                                <input type="checkbox" name="valid" value="1" @if(old('valid')) checked @endif>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <label class="custom-control mt-4">
                                <input type="checkbox" name="slider_image" value="1" @if(old('slider_image')) checked @endif>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('slider_image_file')) has-danger @endif">
                                <input type="file" name="slider_image_file" class="dropify" data-max-file-size="3M" value="{{ old('slider_image_file') }}"/>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <label class="custom-control mt-4">
                                <input type="checkbox" name="menu_image" value="1" @if(old('menu_image')) checked @endif>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('menu_image_file')) has-danger @endif">
                                <input type="file" name="menu_image_file" class="dropify" data-max-file-size="3M" value="{{ old('menu_image_file') }}"/>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <label class="custom-control mt-4">
                                <input type="checkbox" name="best_deals" value="1" @if(old('best_deals')) checked @endif>
                                <span class="checkbox">List in Best Deals</span>
                            </label>
                            <label class="custom-control mt-4">
                                <input type="checkbox" name="category_featured" value="1" @if(old('category_featured')) checked @endif>
                                <span class="checkbox">List in Category Featured</span>
                            </label>
                            <label class="custom-control mt-4">
                                <input type="checkbox" name="follow_link" value="1" @if(old('follow_link')) checked @endif>
                                <span class="checkbox">Use follow link to Deal</span>
                            </label>
                            <label class="custom-control mt-4">
                                <input type="checkbox" name="newsletter" value="1" @if(old('newsletter')) checked @endif>
