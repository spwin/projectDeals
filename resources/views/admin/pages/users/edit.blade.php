...
@section('content')
    ...
    <div class="outer">
        <form action="{{ route('admin.users.save', ['id' => $user->getAttribute('id')]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('first_name')) has-danger @endif">
                                ...
                                <input type="text" id="first_name" class="form-control @if($errors->has('first_name')) is-invalid @endif" name="first_name" value="{{ old('first_name', $user->getAttribute('first_name')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('last_name')) has-danger @endif">
                                ...
                                <input type="text" id="last_name" class="form-control @if($errors->has('last_name')) is-invalid @endif" name="last_name" value="{{ old('last_name', $user->getAttribute('last_name')) }}"/>
                            ...
                            <div class="col-lg-12 input_field_sections @if($errors->has('email')) has-danger @endif">
                                ...
                                <input type="text" id="email" class="form-control @if($errors->has('email')) is-invalid @endif" name="email" value="{{ old('email', $user->getAttribute('email')) }}"/>
                                @if($errors->has('email'))
                ...
                <div class="col-md-6">
                        ...
                        <div class="card-body row">
                            <div class="col-lg-12 input_field_sections @if($errors->has('image')) has-danger @endif">
                                <input type="file" name="image" class="dropify" data-max-file-size="3M"
                                       @if($avatar = $user->avatar()) data-default-file="{{ $avatar }}" @endif/>
                                @if($errors->has('image'))
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="pull-right">
                                <button type="submit" class="btn btn-mint"><i class="fa fa-save"></i> Change</button>
                            </div>
                        </div>
                    </div>
                </div>
